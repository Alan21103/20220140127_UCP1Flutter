...
import 'package:ucp_1/presentation/loginpage.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/datapiket': (context) => const DataPiketPage(),
        '/datapelanggan': (context) => const DataPelangganPage(),
        '/databarang': (context) => const PendataanBarangPage(),
